...
class MainViewModel : ViewModel() {
    ...
    // User State
    private var _activeUser: com.google.mediapipe.examples.facelandmarker.database.User? = null
    val activeUser: com.google.mediapipe.examples.facelandmarker.database.User? get() = _activeUser

    fun setActiveUser(user: com.google.mediapipe.examples.facelandmarker.database.User) {
        _activeUser = user
    }
}