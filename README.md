...
Bu proje, saç ekimi veya analizi süreçlerinde kullanıcıların kendi fotoğraflarını (selfie), belirlenen 5 kritik açıdan yardım almadan, tutarlı ve yüksek doğrulukla çekebilmelerini sağlayan akıllı bir Android mobil uygulamasıdır.
...
3.  **Matematiksel Modelleme (Pose Estimation):**
...
1.  **Tam Yüz Karşıdan:** `H(0,0,0)`
    
2.  **45 Derece Sağa Bakış:** `H(0,-45,0)`
    
3.  **45 Derece Sola Bakış:** `H(0,45,0)`
    
4.  **Tepe Kısmı (Vertex):** `H(45,0,0)` - _Vektörel projeksiyon ile tahmin edilir._
    
5.  **Arka Donör Bölgesi:** `H(180,0,0)` - _Nesne tespiti ile yakalanır._
...
![Overall IOU](https://i.hizliresim.com/k79e2wc.png)

![right](https://i.hizliresim.com/7fvc0zl.png)
![left](https://i.hizliresim.com/4ufv519.png)

![tophead](https://i.hizliresim.com/jmk9qnm.png)
